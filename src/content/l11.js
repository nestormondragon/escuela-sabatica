  ...
  stations: [
    /* 1 · SÁBADO — la jovencita bajo la lluvia */
    {
      ...
      module: {
        ...
        seedSub: "tu tormenta",
        options: [
          { id: "salud",     label: "Mi salud (o la de alguien)", insight: "Como la mujer enferma de Marcos 5, el cuerpo cansa la fe. Pero Jesús todavía distingue el toque de quien se acerca de verdad.", tags: ["theme:hope", "posture:clinging", "tone:tender"] },
          { id: "dinero",    label: "Dificultades económicas",    insight: "La escasez grita fuerte. Aun así, el que viste los lirios conoce exactamente lo que te falta y lo que necesitas.", tags: ["theme:faith", "posture:seeking", "tone:tender"] },
          { id: "relacion",  label: "Una relación rota",          insight: "Pocas tormentas duelen como la del corazón. Jesús no minimiza tu dolor: entra en la barca contigo.", tags: ["theme:relationship", "posture:clinging", "tone:tender"] },
          { id: "perdida",   label: "Una pérdida · un duelo",     insight: "Job conoció esa noche. Llorar no es falta de fe; es el lenguaje del amor herido, y Dios lo entiende.", tags: ["theme:hope", "posture:clinging", "tone:raw"] },
          { id: "fe",        label: "Dudas en mi fe",             insight: "«¡Creo! ¡Ayuda mi poca fe!» (Mar. 9:24) es una de las oraciones más honestas de la Biblia — y Dios la respondió.", tags: ["react:doubt", "theme:faith", "posture:seeking", "tone:raw"] },
          { id: "trabajo",   label: "Presión en el trabajo",      insight: "Lo urgente puede ahogar lo importante. Pero ninguna agenda es más grande que el cuidado de tu Padre.", tags: ["theme:self", "posture:seeking", "tone:resolute"] },
          { id: "familia",   label: "Mi familia",                 insight: "Cargas a los que amas y no puedes arreglarlo todo. Tampoco se te pide: se te pide confiárselos a Aquel que sí puede.", tags: ["theme:relationship", "posture:clinging", "tone:tender"] },
          { id: "futuro",    label: "Lo incierto · el futuro",    insight: "La niebla del mañana asusta. Pero «él conoce el camino que tomo» (Job 23:10), aunque tú aún no lo veas.", tags: ["theme:hope", "posture:seeking", "tone:tender"] },
        ],
      },
    },
    ...
    /* 2 · DOMINGO — Marcos 4, la tormenta calmada */
    {
      ...
      module: {
        ...
        options: [
          { id: "duda",     label: "Dudar que a Dios le importe", insight: "Igual que los discípulos. Pero él no estaba ausente: estaba en la barca. Su silencio no es indiferencia.", tags: ["react:doubt", "theme:faith", "posture:seeking", "tone:raw"] },
          { id: "miedo",    label: "Aterrarme · paralizarme",      insight: "«¿Por qué tenéis miedo? ¿Cómo no tenéis fe?» (Mar. 4:40). El miedo no te descalifica; es la invitación a despertar a Cristo.", tags: ["react:fear", "theme:faith", "posture:seeking", "tone:tender"] },
          { id: "control",  label: "Intentar controlarlo todo",    insight: "Los discípulos eran marineros expertos y aun así no pudieron. Hay tormentas que solo Jesús calma.", tags: ["react:control", "theme:self", "posture:proud", "tone:resolute"] },
          { id: "aguantar", label: "Bajar la cabeza y aguantar",   insight: "Resistir sola/o parece fortaleza, pero te pierdes el milagro. La fe no aprieta los dientes: clama.", tags: ["react:withdraw", "theme:self", "posture:avoidant", "tone:raw"] },
          { id: "culpa",    label: "Preguntarme qué hice mal",     insight: "No toda tormenta es castigo. Jesús los llevó a esa travesía a propósito, para enseñarles a confiar.", tags: ["react:doubt", "theme:grace", "posture:seeking", "tone:tender"] },
          { id: "clamar",   label: "Clamar a Jesús",               insight: "Ya vas en la dirección correcta. Despertarlo fue, en sí mismo, un acto de fe. Sigue clamando.", tags: ["theme:prayer", "posture:surrendering", "tone:tender"] },
        ],
      },
    },
