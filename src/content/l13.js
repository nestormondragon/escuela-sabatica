  ...
  stations: [
    /* 1 · SÁBADO / DOMINGO — fijar los ojos */
    {
      ...
      module: {
        ...
        options: [
          { id: "pantalla", label: "A la pantalla",          insight: "Lo que miramos nos forma. Mil reclamos pequeños pueden robar la mirada que sostiene el alma." },
          { id: "miedos",   label: "A mis miedos",            insight: "El miedo agranda la tormenta y achica al Salvador. Levantar los ojos cambia el tamaño de todo." },
          { id: "pasado",   label: "Al pasado",               insight: "Mirar atrás paraliza. La esperanza no vive en lo que fue, sino en Aquel que viene." },
          { id: "otros",    label: "A lo que tienen otros",   insight: "Comparar nubla la vista. Tus ojos en el Señor te devuelven la paz que la envidia roba." },
          { id: "logros",   label: "A mis logros y planes",   insight: "«¿Qué es vuestra vida? Un vapor» (Stg. 4:14). Lo bueno puede desplazar a lo eterno si no levantamos la vista." },
        ],
      },
    },
    ...
    /* 2 · DOMINGO — viviendo hoy */
    {
      ...
      module: {
        ...
        options: [
          { id: "perdon",   label: "Una relación que reparar",  insight: "El reloj que de verdad corre no es el del fin del mundo, sino el de un «perdóname» que no dijiste." },
          { id: "dios",     label: "Mi relación con Dios",       insight: "Reavivar no es empezar de cero; es volver a encender lo que el ajetreo apagó." },
          { id: "prioridad",label: "Mis prioridades",            insight: "Cuando el tiempo es breve, lo urgente pierde y lo importante gana. Hoy puedes reordenar." },
          { id: "perdonar", label: "Un rencor que soltar",       insight: "Cargar un rencor hacia la Eternidad no tiene sentido. Suéltalo y viaja ligero." },
          { id: "miedo",    label: "Mi miedo al futuro",         insight: "El antídoto del miedo no es el control, sino la confianza en Aquel que sostiene el mañana." },
        ],
      },
    },
    ...
    /* 4 · MARTES — la novia / cosas de arriba */
    {
      ...
      module: {
        ...
        options: [
          { id: "exito",    label: "El éxito y el dinero",   insight: "Lo que acumulas se queda; lo que envías delante por amor te espera. ¿Dónde está tu tesoro?" },
          { id: "comodidad",label: "La comodidad",            insight: "El cielo no es para los que aman su comodidad más que su Salvador. Pero él la transforma en anhelo." },
          { id: "aprobacion",label: "La aprobación de otros", insight: "Vivir para la mirada de la gente cansa; vivir para su rostro libera." },
          { id: "entreten", label: "El entretenimiento",      insight: "No todo lo que llena el tiempo alimenta el alma. Educa tus gustos para el Cielo desde ahora." },
          { id: "control",  label: "Controlar mi futuro",     insight: "Soltar el control no es perderlo; es ponerlo en manos más fieles que las tuyas." },
        ],
      },
    },
