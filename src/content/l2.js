...
export default makeLesson(
{
  ...
  "outAccion24": "En las próximas 24 horas voy a {slot:paso|lower}, y voy a mostrarle el verdadero rostro de Dios a {slot:reflejar|or:alguien cercano} con un gesto concreto.",
