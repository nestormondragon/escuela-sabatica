...
export default makeLesson(
{
  ...
  "outAccion24": "En las próximas 24 horas voy a {slot:paso|lower}, y compartiré con {name} alguien cercano cómo la Ley de Dios, lejos de limitarme, protege mi relación con él. Daré un paso real para quitar {slot:tropiezo|lower} de mi camino.",
